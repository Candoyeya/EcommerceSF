...
Partial Class frmLogin
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If IsNumeric(usu.Value) Then
            ...
            Respuesta = ws.ExecuteSQL(Session("Token"), "Select top 1 * from OSLP where SlpCode='" & usu.Value & "' AND U_IL_pass='" & pass.Value & "'")
    ...
    Public Function buscaCliente() As Boolean
        Dim Respuesta As XmlNode
        Respuesta = ws.ExecuteSQL(Session("Token"), "Select top 1 T0.CardCode,T0.CardName,T0.Address,T0.ZipCode,T0.Currency,T0.E_Mail from OCRD T0 where CardCode='" & usu.Value & "' AND U_IL_pass='" & pass.Value & "'")
